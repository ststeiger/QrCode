/*
* Copyright 2008 libQrCode authors
*
...
namespace libQrCode
{
    ...
    public enum EncodeHintType
    {
        ...
        /// <see cref="libQrCode.QrCode.Internal.ErrorCorrectionLevel" />
        ...
        /// For PDF417 it is of type <see cref="libQrCode.PDF417.Internal.PDF417ErrorCorrectionLevel"/> or <see cref="System.Int32" /> (between 0 and 8),
        /// </summary>
        ERROR_CORRECTION,
        ...
        /// type: <see cref="libQrCode.PDF417.Internal.PDF417AspectRatio" />, or 1-4.
        /// </summary>
        PDF417_ASPECT_RATIO,
        ...
        /// type: <see cref="libQrCode.PDF417.Internal.Compaction" /> or <see cref="System.String" /> value of one of its
        /// enum values
        /// </summary>
        PDF417_COMPACTION,
        ...
        /// type: <see cref="libQrCode.PDF417.Internal.Dimensions" />
        /// </summary>
        PDF417_DIMENSIONS,

        /// <summary>
        /// The Specifies that the PDF417 will contain macro metadata.
        /// type: <see cref="libQrCode.PDF417.PDF417MacroMetadata"/>
        /// </summary>
        ...
        /// <summary>
        /// Specifies the matrix shape for Data Matrix (type <see cref="libQrCode.Datamatrix.Encoder.SymbolShapeHint"/>)
        /// </summary>
        DATA_MATRIX_SHAPE,

        /// <summary>
        /// Specifies a minimum barcode size (type <see cref="libQrCode.Dimension"/>). Only applicable to Data Matrix now.
        /// </summary>
        MIN_SIZE,

        /// <summary>
        /// Specifies a maximum barcode size (type <see cref="libQrCode.Dimension"/>). Only applicable to Data Matrix now.
        /// </summary>
        MAX_SIZE,
        ...
        /// <summary>
        /// Specifies the default encodation for Data Matrix (type <see cref="libQrCode.Datamatrix.Encoder.Encodation"/>)
